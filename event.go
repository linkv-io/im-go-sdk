...
func (o *im) PushEventData(fromUID, toUID, objectName, content, pushData, toAppID, toUserExtSysUserID, isCheckSensitiveWords string) (bool, error) {
	nonce := genGUID()
	...
	uri := o.imHost + "/api/rest/sendEventMsg"
